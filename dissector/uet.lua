...
-- PDS_NEXT_HDR
local UET_HDR_REQUEST_SMALL = 0  -- 0x0
local UET_HDR_REQUEST_MEDIUM = 1  -- 0x1
local UET_HDR_REQUEST_STD = 2  -- 0x2
local UET_HDR_RESPONSE = 3  -- 0x3
local UET_HDR_RESPONSE_DATA = 4  -- 0x4
local UET_HDR_RESPONSE_DATA_SMALL = 5  -- 0x5
...
local TYPE_UUD_REQ = 5  -- 0x5
local TYPE_RUDI_RESP = 6  -- 0x6
local TYPE_PDS_ACK = 7  -- 0x7
local TYPE_CTRL = 8  -- 0x8
